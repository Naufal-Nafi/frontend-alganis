...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            try {
                const response = await fetch(`http://127.0.0.1:8000/api/expense/edit/${id}`, {
                    headers: {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            form.addEventListener('submit', async function (e) {
                ...
                try {
                    const response = await fetch(`http://127.0.0.1:8000/api/expense/update/${id}`, {
                    ...
                    if (response.ok) {
                        ...
                        window.location.href = '/barang'; // redirect setelah update
                    } else {
