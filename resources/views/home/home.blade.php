...
@section('content')
    ...
    <script>
        ...
        async function fetchDashboardData(page = 1) {
            try {
                ...
                const response = await fetch(`http://127.0.0.1:8000/api/dashboard?page=${page}`, {
                    headers: {
        ...
        async function fetchExpensesData(page = 1) {
            try {
                ...
                const response = await fetch(`http://127.0.0.1:8000/api/expense?page=${page}`, {
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Accept': 'application/json'
                    }
    ...
    <script>
        const reportFrames = [
            { id: 'dailyReportChart', sectionId: 'dailySection', url: `http://127.0.0.1:8000/api/dashboard/daily-report`, rendered: false },
            { id: 'fortnightlyReportChart', sectionId: 'fortnightlySection', url: `http://127.0.0.1:8000/api/dashboard/fortnightly-report`, rendered: false },
            { id: 'weeklyReportChart', sectionId: 'weeklySection', url: `http://127.0.0.1:8000/api/dashboard/weekly-report`, rendered: false },
            { id: 'monthlyReportChart', sectionId: 'monthlySection', url: `http://127.0.0.1:8000/api/dashboard/monthly-report`, rendered: false }
        ];
    ...
    <script>
        ...
        async function renderChart(frame) {
            try {
                const token = localStorage.getItem('auth_token');
                const response = await fetch(`http://127.0.0.1:8000/api/dashboard/income-percentage/${frame.days}`, {
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Accept': 'application/json'
                    }
    ...
    <script>
        async function renderStoreIncomeChart() {
            try {
                const token = localStorage.getItem('auth_token');
                const response = await fetch(`http://127.0.0.1:8000/api/dashboard/store-income-percentage`, {
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Accept': 'application/json'
                    }
